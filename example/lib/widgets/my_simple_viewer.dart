...
class MyQuillSimpleViewer extends StatefulWidget {
  const MyQuillSimpleViewer({
  ...
  @override
  _MyQuillSimpleViewerState createState() => _MyQuillSimpleViewerState();
}

class _MyQuillSimpleViewerState extends State<MyQuillSimpleViewer>
